...
public interface StudentCourseService<T, E, S, F> {
    ...
    public F deleteStudentFromCourse(F studentId, F courseId) 
            throws ServicesException.DeleteStudentFormCourseFailure; 
    public S getAllStudentCourse() throws ServicesException.GetAllStudentCourseFailure;
    public F addStudentToCourse(F studentId, F courseId) throws ServicesException.AddNewStudentFailure;
